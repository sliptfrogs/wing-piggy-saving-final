...
export default function Notifications() {
  ...
  const notifications: AppNotification[] =
    (notificationsPage?.content as AppNotification[]) || [];
                  ...
                  <AnimatePresence>
                    {items.map((n, i) => {
                      ...
                      const { icon: Icon, color } =
                        typeConfig[notifType] || typeConfig.system;
                      return (
                        <motion.div
                          key={n.id}
                          ...
                          className={`flex items-center gap-3 sm:gap-4 px-4 sm:px-5 py-2 transition-colors cursor-pointer group ${
                            !n.read
                              ? 'hover:bg-primary/5'
                        ...
                        >
                          <div
                            className={`w-8  h-8 sm:w-9 sm:h-9 rounded-xl flex items-center justify-center shrink-0 mt-0.5 ${color}`}
                          >
