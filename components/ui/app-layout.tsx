...
// import { useNotifications } from '@/hooks/useAccounts'; // adjust import if needed

const navItems = [
  { icon: Home, label: 'Home', path: '/dashboard' }, // path adjusted for Next.js – root is /dashboard
...
export default function AppLayout({ children }: { children: ReactNode }) {
  ...
  // Mock notifications or import your real hook
